...
def generate_quote():
    chat_messages = [
        ...
        {"role": "user", "content": "Give me an existing quote from a developer with his name. Include 1-2 related hashtags for Twitter. Be conversational. Keep your copy short and sweet. You can use emojis. Your Tweet can contain up to 280 characters, formatted starting with the quote followed by the name and be conversational at the end."},
    ]
